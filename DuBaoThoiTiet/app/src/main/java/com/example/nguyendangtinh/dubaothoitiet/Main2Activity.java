                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i< jsonArrayList.length(); i++){
                                ...
                                long l = Long.valueOf(ngay); // chuyển kiểu biến ngay về kiểu dữ liệu long
                                ...
                                String NhietDoMax = String.valueOf(a.intValue()); // chuyển nhiệt độ về kiểu int
                                String NhietDoMin = String.valueOf(b.intValue()); // chuyển nhiệt độ về kiểu int
